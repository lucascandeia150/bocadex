      ...
      <SidebarContent className="bg-gradient-to-b from-sidebar to-sidebar/95">
        ...
        <div className="px-4 pt-4 pb-3 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <img src={logo} alt="Bocadex Delivery's" className="w-11 h-11 rounded-2xl shadow-sm" />
            <div className="min-w-0 flex-1">
              <p className="text-base font-black text-sidebar-foreground leading-tight">Bocadex Delivery's</p>
              {version && (
                <button
                  onClick={markSeen}
