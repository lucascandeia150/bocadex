...
export const drinks: Food[] = [
  {
    ...
    recipe: {
      ...
      steps: ["Peça pelo WhatsApp", "Retire na loja ou combine a retirada", "Aproveite! 🍻"],
      prepTime: "Rápido",
      costEstimate: 5,
    },
    delivery: {
...
export const foods2: Food[] = [
  {
    ...
    recipe: {
      ...
      prepTime: "40min",
      costEstimate: 15,
      videoUrl: "https://youtu.be/2VMBSKyHNO4?si=c77g9YV4sjocq7Pz",
    },
    delivery: { available: false, estimatedTime: "", platform: "", url: "" },
  },
  {
    ...
    recipe: {
      ...
      costEstimate: 8,
      videoUrl: "https://youtube.com/shorts/gHb9by3mDwc?si=f5a0xDRRwF-NzlPS",
    },
    delivery: { available: false, estimatedTime: "", platform: "", url: "" },
  },
];
