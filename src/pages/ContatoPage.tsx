  ...
  return (
    <div className="flex flex-col items-center px-6 pt-8 pb-10 gap-5">
      <div className="text-center animate-bounce-in">
        <img src={logo} alt="Bocadex Delivery's" className="w-20 h-20 mx-auto mb-2 object-contain drop-shadow-lg" />
      ...
      <div className="w-full max-w-sm space-y-4 animate-slide-up">
        ...
        <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h2 className="text-lg font-bold text-foreground">Sobre o Bocadex Delivery's</h2>
          </div>
          <p className="text-sm text-muted-foreground leading-relaxed">
            O Bocadex Delivery's conecta você às melhores opções de comida de forma rápida e prática.
        ...
        <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
          ...
          <a
            href="https://wa.me/5533998669482?text=Ol%C3%A1!%20Entrei%20em%20contato%20pelo%20app%20Bocadex Delivery's%20%F0%9F%98%84"
            target="_blank"
        ...
        <div className="bg-card rounded-2xl p-5 border border-border shadow-sm">
          ...
          <a
            href="https://wa.me/5533998669482?text=Ol%C3%A1!%20Tenho%20interesse%20em%20ser%20parceiro%20do%20Bocadex Delivery's%20%F0%9F%A4%9D"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p className="text-[10px] text-muted-foreground text-center mt-4">
        © 2026 Bocadex Delivery's — Feito com ❤️ para acabar com a indecisão
      </p>
    </div>
  );
}
