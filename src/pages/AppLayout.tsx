    ...
    <SidebarProvider defaultOpen={false}>
      <div className="min-h-screen flex w-full overflow-hidden">
        ...
        <div className="flex-1 flex flex-col max-w-lg mx-auto w-full min-h-0">
          ...
          <main className="flex-1 pb-24 overflow-y-auto overscroll-contain">
            <Routes>
          ...
          {!hideAd && (
            <div className="fixed bottom-14 left-0 right-0 z-20 max-w-lg mx-auto pointer-events-none">
...
function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-background no-blur border-b border-border h-14 flex items-center px-3 gap-2">
      <button
