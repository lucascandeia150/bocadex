...
import { Search, X, Clock, DollarSign, ExternalLink } from "lucide-react";
      ...
      {results.length > 0 && (
        <div className="max-w-sm mx-auto">
          ...
          <button
            ...
            className="w-full mt-4 bg-card border border-border rounded-2xl p-3 flex items-center justify-center gap-2 text-sm font-semibold text-muted-foreground active:scale-95 transition-transform"
          >
      ...
      {showEmpty && (
        <div className="max-w-sm mx-auto text-center animate-slide-up">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Tente outro nome ou explore sugestões
          </p>
